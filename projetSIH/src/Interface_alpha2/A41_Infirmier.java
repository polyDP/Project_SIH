 ...
 * @author Ludivine
 */
public class A41_Infirmier extends javax.swing.JFrame {

    /**
     * Creates new form Premiere_page_dma
     */
    public A41_Infirmier() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Première page infirmier");
...
private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        A42_Infirmier fenetre21 = new A42_Infirmier();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(A41_Infirmier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new A41_Infirmier().setVisible(true);
            }
        });
    }

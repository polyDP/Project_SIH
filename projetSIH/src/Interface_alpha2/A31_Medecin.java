 ...
 * @author Ludivine
 */
public class A31_Medecin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Première page du médecin");
...
/**
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String prenomRecherche = splited[1];
        System.out.println(prenomRecherche);
        A32_Medecin fenetre3 = new A32_Medecin(medecin, sql.rechercherPatient(nomRecherche, prenomRecherche,medecin));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(A31_Medecin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(A31_Medecin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(A31_Medecin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

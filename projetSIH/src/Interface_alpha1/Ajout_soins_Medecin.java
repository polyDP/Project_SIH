 ...
 * @author Ludivine
 */
public class Ajout_soins_Medecin extends javax.swing.JFrame {

    /**
     * Creates new form Creation_patient_dma
     */
    public Ajout_soins_Medecin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ajout_soins_Medecin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ajout_soins_Medecin().setVisible(true);
            }
        });
    }

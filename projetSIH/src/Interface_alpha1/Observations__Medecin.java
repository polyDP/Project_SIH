 ...
 * @author Ludivine
 */
public class Observations__Medecin extends javax.swing.JFrame {

    /**
     * Creates new form Creation_patient_dma
     */
    public Observations__Medecin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Observations__Medecin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Observations__Medecin().setVisible(true);
            }
        });
    }

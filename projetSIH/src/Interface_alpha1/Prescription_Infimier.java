 ...
 * @author Ludivine
 */
public class Prescription_Infimier extends javax.swing.JFrame {

    /**
     * Creates new form Creation_patient_dma
     */
    public Prescription_Infimier() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Prescription_Infimier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Prescription_Infimier().setVisible(true);
            }
        });
    }

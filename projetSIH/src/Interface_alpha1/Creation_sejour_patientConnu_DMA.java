 ...
 * @author Ludivine
 */
public class Creation_sejour_patientConnu_DMA extends javax.swing.JFrame {

    /**
     * Creates new form Creation_sejour_DMA
     */
    public Creation_sejour_patientConnu_DMA() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("création d'un séjour patient");
        ...
        jLabel4.setText("Ouverture d'un dossier patient");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Creation_sejour_patientConnu_DMA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Creation_sejour_patientConnu_DMA().setVisible(true);
            }
        });
    }

 ...
 * @author Ludivine
 */
public class Compte_Rendu_Anesthesie extends javax.swing.JFrame {

    /**
     * Creates new form Creation_patient_dma
     */
    public Compte_Rendu_Anesthesie() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Compte_Rendu_Anesthesie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Compte_Rendu_Anesthesie().setVisible(true);
            }
        });
    }

 ...
 * @author Ludivine
 */
public class Prescription_Anesthesie extends javax.swing.JFrame {

    /**
     * Creates new form Creation_patient_dma
     */
    public Prescription_Anesthesie() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Prescription infirmier");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Prescription_Anesthesie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Prescription_Anesthesie().setVisible(true);
            }
        });
    }

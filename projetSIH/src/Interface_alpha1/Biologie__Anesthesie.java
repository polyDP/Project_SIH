 ...
 * @author Ludivine
 */
public class Biologie__Anesthesie extends javax.swing.JFrame {

    /**
     * Creates new form Creation_patient_dma
     */
    public Biologie__Anesthesie() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Biologie__Anesthesie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Biologie__Anesthesie().setVisible(true);
            }
        });
    }

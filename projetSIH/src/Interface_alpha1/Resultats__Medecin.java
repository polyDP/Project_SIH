 ...
 * @author Ludivine
 */
public class Resultats__Medecin extends javax.swing.JFrame {

    /**
     * Creates new form Creation_patient_dma
     */
    public Resultats__Medecin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton5.setText("Compte-rendu Anesthésie");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Resultats__Medecin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Resultats__Medecin().setVisible(true);
            }
        });
    }

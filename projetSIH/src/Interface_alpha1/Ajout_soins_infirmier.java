 ...
 * @author Ludivine
 */
public class Ajout_soins_infirmier extends javax.swing.JFrame {

    /**
     * Creates new form Creation_patient_dma
     */
    public Ajout_soins_infirmier() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Ajouter un soin");
        jPanel7.add(jLabel5);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Glycémie", "Température", "Tension", "Poids", "Médicament", "ECG", "Perfusion", "..." }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ajout_soins_infirmier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ajout_soins_infirmier().setVisible(true);
            }
        });
    }

 ...
 * @author Ludivine
 */
public class Observations_Anesthesie extends javax.swing.JFrame {

    /**
     * Creates new form Creation_patient_dma
     */
    public Observations_Anesthesie() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Observations_Anesthesie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Observations_Anesthesie().setVisible(true);
            }
        });
    }

 ...
 * @author Ludivine
 */
public class Lettres_sortie__Medecin extends javax.swing.JFrame {

    /**
     * Creates new form Creation_patient_dma
     */
    public Lettres_sortie__Medecin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Lettre de sortie");
        jPanel7.add(jLabel5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lettres_sortie__Medecin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lettres_sortie__Medecin().setVisible(true);
            }
        });
    }

 ...
 * @author Ludivine
 */
public class Imagerie_Medicotechnique extends javax.swing.JFrame {

    /**
     * Creates new form Creation_patient_dma
     */
    public Imagerie_Medicotechnique() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Résultats d'imagerie");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Imagerie_Medicotechnique.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Imagerie_Medicotechnique().setVisible(true);
            }
        });
    }
